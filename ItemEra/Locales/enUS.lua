...
L["SETTINGS_EXPORT_DATA_NAME"] = "Export Calendar Events to JSON"
L["SETTINGS_EXPORT_DATA_DESC"] = "Export all game calendar events to JSON format"

L["Export Calendar Events"] = "Export Calendar Events"
L["Export all game calendar events to JSON format. Copy the text below and save it to a file."] = "Export all game calendar events to JSON format. Copy the text below and save it to a file."
L["Generate JSON Export"] = "Generate JSON Export"
L["Generating..."] = "Generating..."
L["JSON Export Output:"] = "JSON Export Output:"
L["Click 'Generate JSON Export' button to create the export."] = "Click 'Generate JSON Export' button to create the export."
L["JSON export generated successfully! Select all text and copy it."] = "JSON export generated successfully! Select all text and copy it."
L["Tip:"] = "Tip:"
L["Use Ctrl+A to select all text, then Ctrl+C to copy."] = "Use Ctrl+A to select all text, then Ctrl+C to copy."
L["Close"] = "Close"
