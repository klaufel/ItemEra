...
L["SETTINGS_WRAP_PROFESSION_TEXT_NAME"] = "Ajustar texto de profesión"
L["SETTINGS_WRAP_PROFESSION_TEXT_DESC"] = "Ajusta el texto de profesión a varias líneas cuando es demasiado largo"
