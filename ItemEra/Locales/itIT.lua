...
L["SETTINGS_USE_KEY_MODIFIER_DESC"] = "Mostra le informazioni dell'espansione solo quando un tasto modificatore è tenuto premuto."

L["SETTINGS_KEY_MODIFIER_NAME"] = "Tasto modificatore"
L["SETTINGS_KEY_MODIFIER_DESC"] = "Seleziona il tasto modificatore che verrà utilizzato per mostrare le informazioni dell'espansione."
...
L["SETTINGS_RELOAD_REQUIRED"] = "Le modifiche ai filtri richiedono il ricaricamento dell'interfaccia (/reload) per essere applicate."
L["SETTINGS_RELOAD_POPUP_TEXT"] = "Le modifiche ai filtri richiedono il ricaricamento dell'interfaccia per essere applicate."
...
L["SETTINGS_DECORATIONS_ENABLED_DESC"] = "Mostra una piccola icona dell'espansione su ogni oggetto nelle tue borse. Passa il mouse sull'icona per vedere il nome dell'espansione."
...
L["SETTINGS_BAGANATOR_DESCRIPTION_ACTIVE"] = "ItemEra aggiungerà icone dell'espansione agli angoli degli oggetti in Baganator. I filtri nativi sono disabilitati quando Baganator è attivo."
L["SETTINGS_BAGANATOR_DESCRIPTION_INACTIVE"] = "Installa Baganator per utilizzare l'integrazione delle categorie per espansione."
...
L["SETTINGS_BAGNON_DESCRIPTION_ACTIVE"] = "ItemEra aggiungerà filtri dell'espansione a Bagnon. I filtri nativi sono disabilitati quando Bagnon è attivo."
