...
L["SETTINGS_KEY_MODIFIER_DESC"] = "Выберите клавишу-модификатор, которая будет использоваться для отображения информации о дополнении."
...
L["SETTINGS_DECORATIONS_ENABLED_DESC"] = "Показывает маленький значок дополнения на каждом предмете в ваших сумках. Наведите курсор на значок, чтобы увидеть название дополнения."
...
L["SETTINGS_BAGANATOR_DESCRIPTION_ACTIVE"] = "ItemEra добавит значки дополнений в углы предметов в Baganator. Встроенные фильтры отключены, когда Baganator активен."
L["SETTINGS_BAGANATOR_DESCRIPTION_INACTIVE"] = "Установите Baganator для использования интеграции категорий по дополнениям."
...
L["SETTINGS_BAGNON_DESCRIPTION_ACTIVE"] = "ItemEra добавит фильтры дополнений в Bagnon. Встроенные фильтры отключены, когда Bagnon активен."
